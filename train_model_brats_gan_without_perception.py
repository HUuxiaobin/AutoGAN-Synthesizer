...
parser.add_argument('--save', type=str, default='EXP_gan_loss_v2_perception', help='experiment name')
...
def perception_loss(logits,target,aggregate_style_loss,aggregate_content_loss,aggregate_tv_loss):
#------------------perception loss------------------
...
#                            transforms.Normalize((0.5,0.5,0.5), (1,1,1))
    ...
    #----------- training
        train(train_queue, model,netD, optimizer,d_losses,total_losses,content_losses,adv_losses,epoch,aggregate_style_loss,aggregate_content_loss,aggregate_tv_loss)
    # validation
...
def train(train_queue, model,netD, optimizer,d_losses,total_losses,content_losses,adv_losses,epoch,aggregate_style_loss,aggregate_content_loss,aggregate_tv_loss):
    mse_loss = nn.MSELoss()
    bce_loss = nn.BCELoss()
...
#--------perception loss
        content_loss=perception_loss(logits, target,aggregate_style_loss,aggregate_content_loss,aggregate_tv_loss)
##------------------------------
