...
def split_single_images(stack_images,seg_images,file_loc,file_name,stack_images_t2_loop,stack_images_flair_loop,stack_images_t1_loop):
...
stack_images_t2 = np.ndarray((155, 240, 240), dtype=np.float32)
stack_images_t1 = np.ndarray((155, 240, 240), dtype=np.float32)
stack_images_flair = np.ndarray((155, 240, 240), dtype=np.float32)
'''
file_loc='paired_brats/val'
soure_loc='/raid/data_srl/projects/miccai/LGG/val'
...
i=1
for subject_id in glob.glob(soure_loc+'/*/*')[:20]:
    print(subject_id)
    ...
    #print(i)
    if i%5==0:
        split_single_images(stack_images_t1ce,stack_images_seg,file_loc,b,stack_images_t2,stack_images_flair,stack_images_t1)
